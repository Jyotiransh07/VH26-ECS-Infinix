...
const createIcon = (name: string, pathData: React.ReactNode) => {
...
export const BookOpenCheck = createIcon('BookOpenCheck', (
  <>
    ...
    <path d="M22 6V3h-6c-2.2 0-4 1.8-4 4v14c0-1.7 1.3-3 3-3h7v-7" />
  </>
));
...
export const Webhook = createIcon('Webhook', (
  <>
    ...
    <path d="m6 17 3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06l2.9 5.34" />
